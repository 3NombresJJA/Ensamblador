...
SOURCEFILES_QUOTED_IF_SPACED=Main_Seguridad.c lcd.c keypad.c LedsSalida.c ADC.c Timer0.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Main_Seguridad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/LedsSalida.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/Timer0.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Main_Seguridad.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/keypad.p1.d ${OBJECTDIR}/LedsSalida.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/Timer0.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Main_Seguridad.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/keypad.p1 ${OBJECTDIR}/LedsSalida.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/Timer0.p1

# Source Files
SOURCEFILES=Main_Seguridad.c lcd.c keypad.c LedsSalida.c ADC.c Timer0.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/Seguridad_Box.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Seguridad_Box.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"C:/Program Files/Microchip/xc8/v2.36/pic/include/proc" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Seguridad_Box.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
