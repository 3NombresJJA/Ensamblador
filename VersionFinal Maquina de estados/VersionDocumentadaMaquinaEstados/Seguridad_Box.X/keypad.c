...
\file   KEYPAD.c
\date   2023-11-12
\author <juan jose angel, juan camilo fernandez, rafeal parra>
...
/**
 * @brief Inicializa el teclado matricial 4x4.
 *
 * Esta función se encarga de inicializar el teclado matricial 4x4.
 */
...
/**
 * @brief Obtiene la tecla presionada en el teclado matricial 4x4.
 *
